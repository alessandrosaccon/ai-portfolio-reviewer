...
export function UserMenu({ user }: UserMenuProps) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div role="menu" className="absolute right-0 top-full z-50 mt-1.5 w-52 rounded-lg border border-border bg-card py-1 shadow-md">
          <div className="px-3 py-2">
            {user.fullName && <p className="text-sm font-medium text-foreground">{user.fullName}</p>}
          ...
          <div className="my-1 h-px bg-border" />
          <button role="menuitem" onClick={handleLogout} disabled={loading}
